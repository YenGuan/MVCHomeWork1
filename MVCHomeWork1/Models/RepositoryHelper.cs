namespace MVCHomeWork1.Models
{
	public static class RepositoryHelper
	{
		...
		public static VW_HomeWorkCount1Repository GetVW_HomeWorkCount1Repository()
		{
			var repository = new VW_HomeWorkCount1Repository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static VW_HomeWorkCount1Repository GetVW_HomeWorkCount1Repository(IUnitOfWork unitOfWork)
		{
			var repository = new VW_HomeWorkCount1Repository();
			repository.UnitOfWork = unitOfWork;
			return repository;
